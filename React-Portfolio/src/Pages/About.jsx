  ...
  return (
    <section id="about">
        ...
        <div className="about-content">
            ...
            <br />Im a junier Front-end developer with advanced web development
            training, with a focus on creating responsive applications.
            <br />Skilled in crafting user-friendly interfaces and passionate
            about delivering seamless user experiences. <br />I have a passion for
            learning new technologies and gaining new experiences, as well as
            regularity and a desire for self-development. <br />Quick adaptation
