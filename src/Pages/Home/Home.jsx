...
import "./home.css";
import WorkExperiencesSec from "./WorkExperiencesSec";
    ...
    <>
      <section id="home" className="bg-(--home-bg-color)">
        <div ref={homeContRef} className="home-content fromlift">
          ...
          <p>
            Passionate about continuous learning and hands-on projects, I’m
            always exploring the latest web technologies to sharpen my skills.
          </p>
